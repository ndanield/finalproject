<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div>
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link active" href="/wall" data-toggle="tooltip" data-placement="top" title="Perfil" data-original-title="Tooltip on top" style="border-right: 1px solid"><img src="/images/playa.jpg" alt="Avatar" class="avatar"/> <strong>${currentUser.name}</strong></a>
            </li>
